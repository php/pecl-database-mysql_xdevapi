...
static void **
xmysqlnd_plugin__get_node_query_plugin_area(const XMYSQLND_NODE_QUERY * object, const unsigned int plugin_id)
{
	...
	DBG_RETURN((void *)((char *)object + sizeof(XMYSQLND_NODE_QUERY) + plugin_id * sizeof(void *)));
}
/* }}} */
