...
struct st_xmysqlnd_plugin__plugin_area_getters
{
	...
	void ** (*get_node_stmt_result_data_area)(const struct st_xmysqlnd_node_stmt_result_data * result, unsigned int plugin_id);
...
#define xmysqlnd_plugin_get_node_stmt_result_data_plugin_area(r, p_id)		xmysqlnd_plugin_area_getters.get_node_stmt_result_data_area((r), (p_id))
...
struct st_xmysqlnd_plugin_methods_xetters
{
	...
	struct st_xmnd_node_stmt_result_data_xetters
	{
		MYSQLND_CLASS_METHODS_TYPE(xmysqlnd_node_stmt_result_data) * (*get)();
		void (*set)(MYSQLND_CLASS_METHODS_TYPE(xmysqlnd_node_stmt_result_data) *methods);
	} node_stmt_result_data;
...
#define xmysqlnd_node_stmt_result_data_get_methods()	xmysqlnd_plugin_methods_xetters.node_stmt_result_data.get()
#define xmysqlnd_node_stmt_result_data_set_methods(m)	xmysqlnd_plugin_methods_xetters.node_stmt_result_data.set((m))
