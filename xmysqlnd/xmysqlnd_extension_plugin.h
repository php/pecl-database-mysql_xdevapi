...
#define xmysqlnd_node_query_result_get_methods()	xmysqlnd_plugin_methods_xetters.node_query.get()
#define xmysqlnd_node_query_result_set_methods(m)	xmysqlnd_plugin_methods_xetters.node_query.set((m))
