...
typedef struct st_xmysqlnd_node_stmt_result *		(*func_xmysqlnd_object_factory__get_node_stmt_result)(MYSQLND_CLASS_METHODS_TYPE(xmysqlnd_object_factory) * factory, struct st_xmysqlnd_node_stmt * stmt, const zend_bool persistent, MYSQLND_STATS * stats, MYSQLND_ERROR_INFO * error_info);
typedef struct st_xmysqlnd_node_stmt_result_data *	(*func_xmysqlnd_object_factory__get_node_stmt_result_data)(MYSQLND_CLASS_METHODS_TYPE(xmysqlnd_object_factory) * factory, struct st_xmysqlnd_node_stmt * stmt, const zend_bool persistent, MYSQLND_STATS * stats, MYSQLND_ERROR_INFO * error_info);
...
MYSQLND_CLASS_METHODS_TYPE(xmysqlnd_object_factory)
{
	...
	func_xmysqlnd_object_factory__get_node_stmt_result_data get_node_stmt_result_data;
