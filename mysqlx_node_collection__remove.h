...
void mysqlx_new_node_collection__remove(zval * return_value, const MYSQLND_CSTRING search_expression, struct st_xmysqlnd_node_collection * schema, const zend_bool clone);
