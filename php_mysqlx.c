...
mysqlx_minit_classes(INIT_FUNC_ARGS)
{
	...
	REGISTER_LONG_CONSTANT("MYSQLX_EXECUTE_ASYNC", MYSQLX_EXECUTE_FLAG_ASYNC, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("MYSQLX_EXECUTE_BUFFERED", MYSQLX_EXECUTE_FLAG_BUFFERED, CONST_CS | CONST_PERSISTENT);
