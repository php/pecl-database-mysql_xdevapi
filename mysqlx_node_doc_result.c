...
mysqlx_node_doc_result_free_storage(zend_object * object)
{
	...
	struct st_mysqlx_node_doc_result * inner_obj = (struct st_mysqlx_node_doc_result *) mysqlx_object->ptr;
...
php_mysqlx_node_doc_result_object_allocator(zend_class_entry * class_type)
{
	...
	struct st_mysqlx_node_doc_result * object = mnd_ecalloc(1, sizeof(struct st_mysqlx_node_doc_result));
	...
	mysqlx_object->zo.handlers = &mysqlx_object_node_doc_result_handlers;
	mysqlx_object->properties = &mysqlx_node_doc_result_properties;
...
mysqlx_register_node_doc_result_class(INIT_FUNC_ARGS, zend_object_handlers * mysqlx_std_object_handlers)
{
	...
	mysqlx_object_node_doc_result_handlers.free_obj = mysqlx_node_doc_result_free_storage;
	{
		...
		INIT_NS_CLASS_ENTRY(tmp_ce, "Mysqlx", "NodeDocResult", mysqlx_node_doc_result_methods);
...
mysqlx_new_doc_result(zval * return_value, XMYSQLND_NODE_STMT_RESULT * result)
{
	...
	if (SUCCESS == object_init_ex(return_value, mysqlx_node_doc_result_class_entry) && IS_OBJECT == Z_TYPE_P(return_value)) {
		...
		struct st_mysqlx_node_doc_result * const object = (struct st_mysqlx_node_doc_result *) mysqlx_object->ptr;
		if (object) {
