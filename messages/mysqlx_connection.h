...
struct st_mysqlx_connection : util::custom_allocable
{
	MYSQLND_VIO		* vio;
	MYSQLND_STATS	* stats;
...
void mysqlx_register_connection_class(INIT_FUNC_ARGS, zend_object_handlers * mysqlx_std_object_handlers);
void mysqlx_unregister_connection_class(SHUTDOWN_FUNC_ARGS);
