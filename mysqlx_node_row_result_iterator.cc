...
struct st_mysqlx_node_row_result_iterator
{
...
/* {{{ mysqlx_node_row_result_iterator::dtor */
static void
XMYSQLND_METHOD(mysqlx_node_row_result_iterator, dtor)(zend_object_iterator * iter)
{
...
/* {{{ mysqlx_node_row_result_iterator::valid */
static int
XMYSQLND_METHOD(mysqlx_node_row_result_iterator, valid)(zend_object_iterator * iter)
{
	struct st_mysqlx_node_row_result_iterator * iterator = (struct st_mysqlx_node_row_result_iterator *) iter;
	DBG_ENTER("mysqlx_node_row_result_iterator::valid");
...
/* {{{ mysqlx_node_row_result_iterator::current_data */
static zval *
XMYSQLND_METHOD(mysqlx_node_row_result_iterator, current_data)(zend_object_iterator * iter)
{
	struct st_mysqlx_node_row_result_iterator * iterator = (struct st_mysqlx_node_row_result_iterator *) iter;
...
/* {{{ mysqlx_node_row_result_iterator::fetch_current_data */
static enum_func_status
XMYSQLND_METHOD(mysqlx_node_row_result_iterator, fetch_current_data)(zend_object_iterator * iter)
{
	struct st_mysqlx_node_row_result_iterator * iterator = (struct st_mysqlx_node_row_result_iterator *) iter;
	DBG_ENTER("mysqlx_node_row_result_iterator::fetch_current_data");
	DBG_INF_FMT("usable=%s  started=%s  row_num=%u", iterator->usable? "TRUE":"FALSE", iterator->started? "TRUE":"FALSE", iterator->row_num);
...
/* {{{ mysqlx_node_row_result_iterator::next */
static void
XMYSQLND_METHOD(mysqlx_node_row_result_iterator, next)(zend_object_iterator * iter)
{
	struct st_mysqlx_node_row_result_iterator * iterator = (struct st_mysqlx_node_row_result_iterator *) iter;
...
/* {{{ mysqlx_node_row_result_iterator::rewind */
static void
XMYSQLND_METHOD(mysqlx_node_row_result_iterator, rewind)(zend_object_iterator * iter)
{
	struct st_mysqlx_node_row_result_iterator * iterator = (struct st_mysqlx_node_row_result_iterator *) iter;
	DBG_ENTER("mysqlx_node_row_result_iterator::rewind");
	if (iterator->result && iterator->usable) {
...
//			XMYSQLND_METHOD(mysqlx_node_row_result_iterator, next)(iter);
		DBG_INF_FMT("usable=%s  started=%s  row_num=%u", iterator->usable? "TRUE":"FALSE", iterator->started? "TRUE":"FALSE", iterator->row_num);
	}
	DBG_VOID_RETURN;
}
...
static zend_object_iterator_funcs mysqlx_node_row_result_iterator_funcs =
{
...
/* {{{ mysqlx_node_row_result_create_iterator */
...
mysqlx_node_row_result_create_iterator(zend_class_entry * ce, zval * object, int by_ref)
{
	...
	struct st_mysqlx_node_row_result * mysqlx_result = mysqlx_object->ptr? mysqlx_object->ptr:NULL;
	struct st_mysqlx_node_row_result_iterator * iterator = NULL;
	...
	iterator = ecalloc(1, sizeof(struct st_mysqlx_node_row_result_iterator));
	if (iterator) {
		zend_iterator_init(&iterator->intern);

		ZVAL_COPY(&iterator->intern.data, object);

		iterator->intern.funcs = &mysqlx_node_row_result_iterator_funcs;
		iterator->row_num = 0;
		iterator->started = FALSE;
		iterator->usable = TRUE;
...
{
	ce->get_iterator = mysqlx_node_row_result_create_iterator;
	ce->iterator_funcs.funcs = &mysqlx_node_row_result_iterator_funcs;
