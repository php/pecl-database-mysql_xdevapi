...
struct st_mysqlx_node_row_result_iterator : mysqlx::phputils::custom_allocable
{
...
mysqlx_node_row_result_create_iterator(zend_class_entry * ce, zval * object, int by_ref)
{
	...
	auto iterator = mysqlx::phputils::create_result_iterator<st_mysqlx_node_row_result, st_mysqlx_node_row_result_iterator>(
		ce,
		&mysqlx_node_row_result_iterator_funcs,
		object,
		by_ref);
