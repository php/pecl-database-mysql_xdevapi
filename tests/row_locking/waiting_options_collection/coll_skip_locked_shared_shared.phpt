--TEST--
mysqlx collection waiting options - shared, shared, skip locked
--SKIPIF--
--INI--
...
if (is_resource($worker_process)) {
	...
	// Call lockShared and worker tries to read a document locked using lockShared
	// and the 'SKIP_LOCKED' waiting option.
	// terminal/cmd 1
