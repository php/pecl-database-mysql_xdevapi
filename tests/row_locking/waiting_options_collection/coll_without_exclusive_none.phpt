--TEST--
mysqlx collection waiting options - exclusive, none lock, without waiting option
--SKIPIF--
--INI--
...
if (is_resource($worker_process)) {
	...
	// Call lockExclusive and worker tries to read a document locked without a waiting option.
	// terminal/cmd 1
