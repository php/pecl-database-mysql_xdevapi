--TEST--
mysqlx collection waiting options - shared, exclusive, without waiting option
--SKIPIF--
--INI--
...
if (is_resource($worker_process)) {
	...
	// Call lockShared and worker tries to read a document locked using lockExclusive without a waiting option.
	// terminal/cmd 1
