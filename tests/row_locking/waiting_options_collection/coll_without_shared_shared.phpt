--TEST--
mysqlx collection waiting options - shared, shared, without waiting option
--SKIPIF--
--INI--
...
if (is_resource($worker_process)) {
	...
	// Call lockShared and worker tries to read a document locked using lockShared without a waiting option.
	// terminal/cmd 1
