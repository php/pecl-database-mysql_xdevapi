--TEST--
mysqlx table waiting options - exclusive, none lock, default waiting option
--SKIPIF--
--INI--
...
if (is_resource($worker_process)) {
	...
	// Call lockExclusive and worker tries to read a document locked
	// with default waiting option.
	// terminal/cmd 1
	$session->startTransaction();
	check_select_lock_one($table, '1', 1, $Lock_exclusive);
