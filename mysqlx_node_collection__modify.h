...
void mysqlx_new_node_collection__modify(zval * return_value, const MYSQLND_CSTRING search_expression,  drv::st_xmysqlnd_node_collection* collection, const zend_bool clone_collection);
