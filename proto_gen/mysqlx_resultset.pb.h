...
inline void ColumnMetaData::clear_original_name() {
  if (original_name_ != &::google::protobuf::internal::kEmptyString) {
...
inline ::std::string* ColumnMetaData::release_original_name() {
  ...
  if (original_name_ == &::google::protobuf::internal::kEmptyString) {
    ...
    original_name_ = const_cast< ::std::string*>(&::google::protobuf::internal::kEmptyString);
    return temp;
  }
}
...
inline void ColumnMetaData::clear_original_table() {
  if (original_table_ != &::google::protobuf::internal::kEmptyString) {
...
inline ::std::string* ColumnMetaData::release_original_table() {
  ...
  if (original_table_ == &::google::protobuf::internal::kEmptyString) {
    ...
    original_table_ = const_cast< ::std::string*>(&::google::protobuf::internal::kEmptyString);
    return temp;
  }
}
...
inline void ColumnMetaData::clear_catalog() {
  if (catalog_ != &::google::protobuf::internal::kEmptyString) {
    catalog_->clear();
  }
  clear_has_catalog();
}
...
inline ::std::string* ColumnMetaData::release_catalog() {
  ...
  if (catalog_ == &::google::protobuf::internal::kEmptyString) {
    ...
    catalog_ = const_cast< ::std::string*>(&::google::protobuf::internal::kEmptyString);
    return temp;
  }
}
