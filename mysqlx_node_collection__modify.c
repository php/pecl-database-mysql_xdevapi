...
ZEND_BEGIN_ARG_INFO_EX(arginfo_mysqlx_node_collection__modify__values, 0, ZEND_RETURN_VALUE, 0)
ZEND_END_ARG_INFO()
...
mysqlx_register_node_collection__modify_class(INIT_FUNC_ARGS, zend_object_handlers * mysqlx_std_object_handlers)
{
...

	{
		...
		zend_class_implements(mysqlx_node_collection__modify_class_entry, 1, mysqlx_executable_interface_entry);
	}
...
void
mysqlx_new_node_collection__modify(zval * return_value, XMYSQLND_NODE_COLLECTION * collection, const zend_bool clone)
{
