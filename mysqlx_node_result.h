/*
  ...
  +----------------------------------------------------------------------+
*/
#ifndef MYSQLX_NODE_RESULT_H
#define MYSQLX_NODE_RESULT_H

#include <phputils/allocator.h>

struct st_xmysqlnd_node_stmt_result;

struct st_mysqlx_node_result : public mysqlx::phputils::custom_allocable
{
	struct st_xmysqlnd_node_stmt_result * result;
};

void mysqlx_new_result(zval * return_value, struct st_xmysqlnd_node_stmt_result * result);
